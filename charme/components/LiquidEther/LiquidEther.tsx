...
import classes from './LiquidEther.module.scss';
...
const defaultColors = ['#5227ff', '#ff9ffc', '#d59eef'];

const LiquidEther = React.memo(
	({
		mouseForce = 20,
		cursorSize = 100,
		isViscous = false,
...
`;
		...
		return <div ref={mountRef} className={classes.LiquidEther} style={style} />;
	}
);

export default React.memo(({ className, ...props }: LiquidEtherProps) => (
